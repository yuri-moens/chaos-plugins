...
public class GuardianInfo {
  public static final GuardianInfo AIR =
      new GuardianInfo(1, ItemID.AIR_RUNE, 26887, 4353, 43701, false, CellType.Weak);
  public static final GuardianInfo MIND =
      new GuardianInfo(2, ItemID.MIND_RUNE, 26891, 4354, 43705, true, CellType.Weak);
  public static final GuardianInfo WATER =
      new GuardianInfo(5, ItemID.WATER_RUNE, 26888, 4355, 43702, false, CellType.Medium);
  public static final GuardianInfo EARTH =
      new GuardianInfo(9, ItemID.EARTH_RUNE, 26889, 4356, 43703, false, CellType.Strong);
  public static final GuardianInfo FIRE =
      new GuardianInfo(14, ItemID.FIRE_RUNE, 26890, 4357, 43704, false, CellType.Overcharged);
  public static final GuardianInfo BODY =
      new GuardianInfo(20, ItemID.BODY_RUNE, 26895, 4358, 43709, true, CellType.Weak);
  public static final GuardianInfo COSMIC =
      new GuardianInfo(27, ItemID.COSMIC_RUNE, 26896, 4359, 43710, true, CellType.Medium);
  public static final GuardianInfo CHAOS =
      new GuardianInfo(35, ItemID.CHAOS_RUNE, 26892, 4360, 43706, true, CellType.Medium);
  ...
  public GuardianInfo(int levelRequired, int runeId, int talismanId, int spriteId, int objectId,
                      boolean isCatalytic, CellType cellType) {
