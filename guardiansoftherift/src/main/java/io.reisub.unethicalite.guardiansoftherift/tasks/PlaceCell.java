...
public class PlaceCell extends Task {
  ...
  public boolean validate() {
    return plugin.getGamePhase() == 10 && Inventory.contains("Weak cell", "Medium cell", "Strong cell", "Overcharged cell");
  }

  @Override
  public void execute() {
    TileObjects.getNearest(43740, 43741, 43742, 43743).interact("Place-cell");
    Time.sleepTicksUntil(() -> !Inventory.contains("Weak cell", "Medium cell", "Strong cell", "Overcharged cell"), 10);
