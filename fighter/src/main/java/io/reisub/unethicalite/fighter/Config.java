...
public interface Config extends net.runelite.client.config.Config {
  ...
  @ConfigItem(
      ...
      name = "Target names",
      description =
          "List of target names. One name per line, case insensitive. You can use * to specify using 'contains' so 'Goblin*' will match Goblins but also Cave goblins, Hobgoblins, ...",
  ...
  @ConfigItem(
      ...
      name = "Exact name",
      description =
          "Target has to match the name exactly (still case insensitive). Turning this off will make 'goblin' match to Goblins, Cave goblins, Hobgoblins, Revenant goblins, ...",
      section = "targetConfig",
      position = 102)
