...
public class Constants {
  ...
  public static final Set<Integer> DIGSITE_PENDANT_IDS =
      ImmutableSet.of(
  ...
  public static final Set<Integer> BIRD_HOUSE_SPACES =
      ImmutableSet.of(
          MEADOW_NORTH_SPACE, MEADOW_SOUTH_SPACE, VERDANT_NORTH_SPACE, VERDANT_SOUTH_SPACE);

  public static final Set<Integer> BIRD_HOUSE_IDS =
      ImmutableSet.of(
          ObjectID.BIRDHOUSE,
  ...
  public static final Set<Integer> BIRD_HOUSE_EMPTY_IDS =
      ImmutableSet.of(
  ...
  public static final Set<Integer> BIRD_HOUSE_ITEM_IDS =
      ImmutableSet.of(
          ItemID.BIRD_HOUSE,
  ...
  public static final Set<Integer> BIRD_NEST_IDS =
      ImmutableSet.of(
          ItemID.BIRD_NEST,
  ...
  public static final Set<Integer> MAGIC_MUSHTREE_IDS =
      ImmutableSet.of(
          ObjectID.MAGIC_MUSHTREE, ObjectID.MAGIC_MUSHTREE_30922, ObjectID.MAGIC_MUSHTREE_30924);

  public static final Set<Integer> ESSENCE_IDS =
      ImmutableSet.of(ItemID.RUNE_ESSENCE, ItemID.PURE_ESSENCE, ItemID.DAEYALT_ESSENCE);

  public static final Set<Integer> ANVIL_IDS =
      ImmutableSet.of(
          ObjectID.ANVIL,
          ObjectID.ANVIL_2097,
  ...
  public static final Set<Integer> STAMINA_POTION_IDS =
      ImmutableSet.of(
  ...
  public static final Set<Integer> PRAYER_RESTORE_POTION_IDS =
      ImmutableSet.of(
  ...
  public static final Set<Integer> ESSENCE_POUCH_IDS =
      ImmutableSet.of(
          ItemID.GIANT_POUCH,
  ...
  public static final Set<Integer> DEGRADED_ESSENCE_POUCH_IDS =
      ImmutableSet.of(ItemID.GIANT_POUCH_5515, ItemID.LARGE_POUCH_5513, ItemID.MEDIUM_POUCH_5511);

  public static final Set<Integer> ARDOUGNE_CLOAK_IDS =
      ImmutableSet.of(
  ...
  public static final Set<Integer> DUELING_RING_IDS =
      ImmutableSet.of(
  ...
  public static final Set<Integer> EXPLORERS_RING_IDS =
      ImmutableSet.of(ItemID.EXPLORERS_RING_2, ItemID.EXPLORERS_RING_3, ItemID.EXPLORERS_RING_4);

  public static final Set<Integer> AMULET_OF_GLORY_IDS =
      ImmutableSet.of(
  ...
  public static final Set<Integer> SKILL_NECKLACE_IDS =
      ImmutableSet.of(
  ...
  public static final Set<Integer> COMPOST_BIN_IDS =
      ImmutableSet.of(
  ...
  public static final Set<Integer> ALLOTMENT_SEED_IDS =
      ImmutableSet.of(
          ItemID.POTATO_SEED,
          ItemID.ONION_SEED,
          ItemID.CABBAGE_SEED,
  ...
  public static final Set<Integer> FLOWER_SEED_IDS =
      ImmutableSet.of(
  ...
  public static final Set<Integer> HERB_SEED_IDS =
      ImmutableSet.of(
          ItemID.GUAM_SEED,
  ...
  public static final Set<Integer> HOPS_SEED_IDS =
      ImmutableSet.of(
          ItemID.BARLEY_SEED,
          ItemID.HAMMERSTONE_SEED,
          ItemID.ASGARNIAN_SEED,
  ...
  public static final Set<Integer> BUSH_SEED_IDS =
      ImmutableSet.of(
  ...
  public static final Set<Integer> TREE_SEED_IDS =
      ImmutableSet.of(
          ItemID.ACORN,
          ItemID.WILLOW_SEED,
          ItemID.MAPLE_SEED,
  ...
  public static final Set<Integer> TREE_SEEDLING_IDS =
      ImmutableSet.of(
          ItemID.OAK_SEEDLING,
  ...
  public static final Set<Integer> TREE_SAPLING_IDS =
      ImmutableSet.of(
          ItemID.OAK_SAPLING,
  ...
  public static final Set<Integer> FRUIT_TREE_SAPLING_IDS =
      ImmutableSet.of(
  ...
  public static final Set<Integer> HARDWOOD_TREE_SAPLING_IDS =
      ImmutableSet.of(ItemID.TEAK_SAPLING, ItemID.MAHOGANY_SAPLING);

  public static final Set<Integer> ANIMA_SEED_IDS =
      ImmutableSet.of(ItemID.KRONOS_SEED, ItemID.IASOR_SEED, ItemID.ATTAS_SEED);

  public static final Set<Integer> CACTUS_SEED_IDS =
      ImmutableSet.of(ItemID.CACTUS_SEED, ItemID.POTATO_CACTUS_SEED);

  public static final Set<Integer> COMPOST_IDS =
      ImmutableSet.of(
          ItemID.COMPOST,
          ItemID.SUPERCOMPOST,
          ItemID.ULTRACOMPOST,
  ...
  public static final Set<Integer> WATERING_CAN_IDS =
      ImmutableSet.of(
  ...
  public static final Supplier<Widget> TOOLS_CLOSE_WIDGET =
      () -> Widgets.get(TOOL_WIDGET_ID, 1, 11);

  public static final Supplier<Widget> TOOLS_WITHDRAW_DIBBER_WIDGET =
      () -> Widgets.get(TOOL_WIDGET_ID, 9);
  public static final Supplier<Widget> TOOLS_WITHDRAW_SPADE_WIDGET =
      () -> Widgets.get(TOOL_WIDGET_ID, 10);
  public static final Supplier<Widget> TOOLS_WITHDRAW_SECATEURS_WIDGET =
      () -> Widgets.get(TOOL_WIDGET_ID, 11);
  public static final Supplier<Widget> TOOLS_WITHDRAW_PLANT_CURE_WIDGET =
      () -> Widgets.get(TOOL_WIDGET_ID, 14);
  public static final Supplier<Widget> TOOLS_WITHDRAW_BOTTOMLESS_BUCKET_WIDGET =
      () -> Widgets.get(TOOL_WIDGET_ID, 15);
  public static final Supplier<Widget> TOOLS_WITHDRAW_COMPOST_WIDGET =
      () -> Widgets.get(TOOL_WIDGET_ID, 17);
  public static final Supplier<Widget> TOOLS_WITHDRAW_SUPERCOMPOST_WIDGET =
      () -> Widgets.get(TOOL_WIDGET_ID, 18);
  public static final Supplier<Widget> TOOLS_WITHDRAW_ULTRACOMPOST_WIDGET =
      () -> Widgets.get(TOOL_WIDGET_ID, 19);

  public static final Supplier<Widget> TOOLS_DEPOSIT_DIBBER_WIDGET =
      () -> Widgets.get(TOOL_WIDGET_ID + 1, 2);
  public static final Supplier<Widget> TOOLS_DEPOSIT_SPADE_WIDGET =
      () -> Widgets.get(TOOL_WIDGET_ID + 1, 3);
  public static final Supplier<Widget> TOOLS_DEPOSIT_SECATEURS_WIDGET =
      () -> Widgets.get(TOOL_WIDGET_ID + 1, 4);
  public static final Supplier<Widget> TOOLS_DEPOSIT_BOTTOMLESS_BUCKET_WIDGET =
      () -> Widgets.get(TOOL_WIDGET_ID + 1, 8);
  public static final Supplier<Widget> TOOLS_DEPOSIT_BUCKET_WIDGET =
      () -> Widgets.get(TOOL_WIDGET_ID + 1, 9);

  public static final Set<Integer> CRAFTING_CAPE_IDS =
      ImmutableSet.of(ItemID.CRAFTING_CAPE, ItemID.CRAFTING_CAPET);

  public static final Set<Integer> REJUVENATION_POOL_IDS =
      ImmutableSet.of(
          ObjectID.POOL_OF_REFRESHMENT,
          ObjectID.ORNATE_POOL_OF_REJUVENATION,
          ObjectID.FROZEN_ORNATE_POOL_OF_REJUVENATION);

  public static final Set<Integer> BARROWS_UNDEGRADED_IDS =
      ImmutableSet.of(
          ItemID.AHRIMS_HOOD,
          ItemID.AHRIMS_STAFF,
  ...
  public static final Set<Integer> TRIDENT_IDS =
      ImmutableSet.of(
  ...
  public static final Set<Integer> GRACEFUL_HOOD =
      ImmutableSet.of(
  ...
  public static final Set<Integer> GRACEFUL_TOP =
      ImmutableSet.of(
          ItemID.GRACEFUL_TOP,
  ...
  public static final Set<Integer> GRACEFUL_LEGS =
      ImmutableSet.of(
  ...
  public static final Set<Integer> GRACEFUL_BOOTS =
      ImmutableSet.of(
  ...
  public static final Set<Integer> GRACEFUL_GLOVES =
      ImmutableSet.of(
  ...
  public static final Set<Integer> GRACEFUL_CAPE =
      ImmutableSet.of(
